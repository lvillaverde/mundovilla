	...
	<section>
		  ...
		  <ul class="slides">
			...
			foreach ($render['lastArticles'] as $article) {
				?>
				    <li>
						<a class="itemSlide">
						    <div class="noticiaSlide_cont">
						      <h2><?php echo $article->getTitle();?></h2>
						      <p><?php echo $article->getPreview();?></p>
		  				      <span>Leer nota</span>
						    </div>
					      	<img src="http://mundovilla.com/uploads/<?php echo $article->getImage()->getUrl(); ?>" class="imgSlide">
						</a>
				    </li>
				<?php
			}
		...
		<div class="noticiasSecundarias" id="grillado">
			...
			<div class="modElement modOtro">
				<embed type="application/x-shockwave-flash" src="http://cdn1.worldtv.com/build/2920-07/flash/embed-player-modern.swf" width="100%" style="height:270px;" id="flexApplication" name="flexApplication" bgcolor="#FFFFFF" quality="high" allowscriptaccess="always" movie="http://cdn1.worldtv.com/build/2920-07/flash/embed-player-modern.swf" allowfullscreen="true" flashvars="domain=http%3A%2F%2Fembed.worldtv.com%2F&amp;rootUrlPath=http%3A%2F%2Fembed.worldtv.com%2F&amp;staticRootUrlPath=http%3A%2F%2Fcdn1.worldtv.com%2Fbuild%2F2920-07%2F&amp;channelId=1519525&amp;currentLang=es&amp;buildId=2920-07&amp;vid=&amp;autoPlay=false">
			</div> -->
